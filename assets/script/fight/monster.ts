...
import { _decorator, Component, Vec3, macro, Node, Quat, clamp, RigidBodyComponent, math } from 'cc';
...
export class Monster extends Component {
    ...
    protected _action: number = 0;//当前行动
    ...
    */
    ...
    protected _monsterMove () {
        ...
        if (this._movePattern === constant.MONSTER_MOVE_PATTERN.NO_MOVE) {
            //不移动，原地攻击玩家
            // this._lookAtTargetWorPos(GameManager.ndPlayer.worldPosition);
            this._stayRotateAttack();
